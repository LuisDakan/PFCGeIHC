...
// Variables para control de cámaras
bool vistaAereaActiva = false;
bool teclaCPresionada = false;
bool vistaHabilitada = false;
bool teclaVPresionada = false;
bool vistaTerceraPersonaActiva = false;
Model piso;
Skybox skybox;
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// Control Tecla V - Vista Aérea
		if (mainWindow.getsKeys()[GLFW_KEY_V] && !teclaVPresionada)
		{
			vistaAereaActiva = !vistaAereaActiva;
			vistaTerceraPersonaActiva = false;
			camera.activarModoAereo(vistaAereaActiva);
			teclaVPresionada = true;
			printf(vistaAereaActiva ? "Modo Vista Aerea ACTIVADO\n" : "Modo Camara Normal ACTIVADO\n");
		}
		...
		// Control Tecla C - 3era Persona
		if (mainWindow.getsKeys()[GLFW_KEY_C] && !teclaCPresionada)
		{
			vistaTerceraPersonaActiva = !vistaTerceraPersonaActiva;
			vistaAereaActiva = false;
			camera.activarModoTerceraPersona(vistaTerceraPersonaActiva);
			teclaCPresionada = true;
			printf(vistaTerceraPersonaActiva ? "Modo Tercera Persona ACTIVADO\n" : "Modo Camara Normal ACTIVADO\n");
		}
